...
[CreateAssetMenu(fileName = "NewDamagePlayEffect",
                 menuName = "CardData/PlayEffects/DefToAtk")]
public class DefToAtk : CardPlayEffect
{
    // update UI
    ...
    public override void Activate()
    {
        ...
        int atkBoost = cardView.Defense;

        cardView.StatChange(cardView.Attack + atkBoost, 0, cardView.Level);
    }
}
